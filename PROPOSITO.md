...
| ~~3~~ | ~~**La cáscara reacciona a la mesa**~~ | ~~Sonnet, medio~~ | **HECHA (tanda 0n, 21-ago), sin jugarla.** Las cinco reacciones de §8 final: iconos, cuadro de error, barra de tareas, registro y pestaña del enemigo. 623/623. Falta oírla y mirarla — ver `ESTADO.md` V1-V5 |
